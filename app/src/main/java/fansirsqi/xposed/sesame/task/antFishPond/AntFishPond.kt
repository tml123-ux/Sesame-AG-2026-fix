...
import fansirsqi.xposed.sesame.task.common.TaskFlowAction
import fansirsqi.xposed.sesame.task.common.TaskFlowActionResult
import fansirsqi.xposed.sesame.task.common.TaskFlowAdapter
import fansirsqi.xposed.sesame.task.common.TaskFlowDecision
import fansirsqi.xposed.sesame.task.common.TaskFlowEngine
import fansirsqi.xposed.sesame.task.common.TaskFlowItem
import fansirsqi.xposed.sesame.task.common.TaskFlowPhase
...
class AntFishPond : ModelTask() {
    ...
    override fun runJava() {
        try {
            ...
            if (indexJson != null) {
                exchangeRewardAndReloadIndex(indexJson, "首页")
            }
